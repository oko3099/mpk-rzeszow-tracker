...
function buildVehicleDb() {
  ...
  // Mercedes-Benz Citaro O530 diesel — dostawa 2006
  add('805-834',           'Mercedes-Benz', 'Citaro O530',         2006);
  add('868-870',           'Mercedes-Benz', 'Citaro O530',         2006);

  // Mercedes-Benz Citaro O530 CNG — dostawa 2012/2013
  add('835-849',           'Mercedes-Benz', 'Citaro O530 CNG',     2012);
  add('850-864',           'Mercedes-Benz', 'Citaro O530 CNG',     2013);

  // Mercedes-Benz Conecto LF — 2013
  add(['865','866','867'], 'Mercedes-Benz', 'Conecto LF',          2013);

  // Autosan Sancity 10LF — 2012/2013
  add('901-910',           'Autosan',     'Sancity 10LF',          2012);
  add('911-920',           'Autosan',     'Sancity 10LF',          2013);
  ...
  add('932-961',           'Autosan',     'Sancity 12LF CNG',      2020);
  add('962-991',           'Autosan',     'Sancity 12LF CNG',      2021);
  ...
  // Solaris Urbino 9 electric
  add('112-117',           'Solaris',     'Urbino 9 LE Electric',  2023);

  // Solaris Urbino 12 (używane)
